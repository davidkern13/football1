        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={styles.copaAmericaText}>COPA AMERICA</Text>
                    <Text style={styles.brazil19Text}>BRAZIL 2019</Text>
                </View>
                <View style={styles.rightsContainer}>
                    <Text style={styles.bigFivePlusText}>By</Text>
                    <Image style={styles.bigFivePlusLogo}
