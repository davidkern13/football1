...
class HomeScreen extends React.Component {
    ...
    render() {
        ...
        return (
          <ImageBackground source={{uri:'http://up419.siz.co.il/up3/t2m2nzy2nikz.png?fbclid=IwAR3lxNk3dBLtfp5WXFkSIvp8xYvUz2sGKcyoBuKrkEOTU6J5kaSsos4Lluk'}}
            ...
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={{color:'white',fontSize:20,fontWeight:'700'}}>COPA AMERICA</Text>
                    <Text style={{color:'green',fontSize:20}}>BRAZIL 2019</Text>
                </View>
                <View style={styles.rightsContainer}>
                    <Text style={{alignSelf:'flex-end',color:'white'}}>By</Text>
