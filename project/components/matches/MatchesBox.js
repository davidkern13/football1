            ...
            <View style={styles.container}>
                <View style={styles.matchDisplay}>
                    <View style={styles.matchRound}> 
                        <Text style={{fontSize:11,color:'#164095',fontWeight:'500',opacity:.7}}>GROUP {this.props.group}, ROUND {this.props.round}</Text>
                    </View>
                        ...
                        <View style={styles.teamScore}>
                            ...
                            <View style={styles.scoreContainer}>
                                <View style={{backgroundColor:'#f4f4f4',borderRadius:6,width:45,height:25,display:'flex',justifyContent:'center',alignItems:'center'}}>
                                    <Text style={{fontSize:14,color:'#a1a1a1'}}>{this.props.scoreTeam1} : {this.props.scoreTeam2}</Text>
                                </View>
                            </View>
                    ...
                    <View style={styles.timeContainer}>
                        <Text style={{color:'#a1a1a1',fontSize:12}}>{this.props.minute || this.props.time}'</Text>
