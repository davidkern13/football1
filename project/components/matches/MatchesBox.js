            ...
            <View style={styles.container}>
                <View style={styles.matchDisplay}>
                    <View style={styles.matchRound}> 
                        <Text style={{fontSize:12,color:'#4c4cff',fontWeight:'600'}}>GROUP {this.props.group}, ROUND {this.props.round}</Text>
                    </View>
                    <View style={styles.matchTeams}> 
                        <View style={styles.teamScore}>
                            <View style={styles.leftTeam}>
                                <Image style={{width: 30, height: 30, borderRadius: 100, marginLeft:8,marginRight:8}}
                            ...
                            <View style={styles.scoreContainer}>
                                <View style={{backgroundColor:'#e3e7ea',width:40,height:20,display:'flex',justifyContent:'center',alignItems:'center'}}>
                                    <Text style={{fontSize:14,color:'#929fad'}}>{this.props.scoreTeam1} : {this.props.scoreTeam2}</Text>
                                </View>
                                <View style={styles.timeContainer}>
                                    <Text style={{color:'#929fad',fontSize:12}}>{this.props.minute || this.props.time}'</Text>
                                    <Text style={{backgroundColor:'green',borderRadius:100,width:7,height:7}}></Text>
                                </View>
                            </View>
