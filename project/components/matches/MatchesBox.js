        ...
        return (
            <View style={styles.container}>
                <View style={styles.containerTop}>
                    ...
                    <Text style={{textAlign:'center',fontSize:15}}>{this.props.date}</Text>
                    <View style={styles.line}></View>
                </View>
                <View style={styles.matchDisplay}>
                    <View style={styles.matchRound}> 
                        <Text style={{fontSize:13,color:'gray',fontWeight:'700'}}>ROUND {this.props.round}</Text>
                        <Text style={{fontSize:13,color:'blue'}}>GROUP {this.props.group}</Text>
                    </View>
                    <View style={styles.matchTeams}> 
                        <Text style={{fontSize:17}}>{this.props.team1}</Text>
                        <View style={styles.teamScore}>
                            ...
                            <Text style={{fontSize:22}}>{this.props.scoreTeam1} : {this.props.scoreTeam2}</Text>
                            <Image style={{width: 30, height: 30, borderRadius: 100}}
                                   source={{uri: 'data:image/png;base64,'}}/>
                        </View>
                        <Text style={{fontSize:17}}>{this.props.team2}</Text>                    
                    </View>
                </View>
            </View>
        );
