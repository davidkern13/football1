            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.containerTopic}>
                        <Image style={{width: 25, height: 25, borderRadius: 100,marginLeft:8,marginRight:8}}
                        ...
                        <View style={styles.teamTopic}>
                            <Text style={{color:'black',fontWeight:'800',fontSize:15}}>Kfar Shalem FC</Text>
                            <Text style={{color:'gray'}}>You follow this team</Text>
                        </View>
                    </View>
                    ...
                    <Text style={{fontSize:20,fontWeight:'700',letterSpacing:.5,padding:8}}>Breaking News! Young team from TLV streets Won UEFA Champions League!</Text>
                    <View style={styles.source}>
                        <Text style={{fontWeight:'700',paddingLeft:8,paddingRight:8}}>ZayanskiNews</Text>
                        <Text>8h</Text>
                    </View>
                    </View>
                </View>
